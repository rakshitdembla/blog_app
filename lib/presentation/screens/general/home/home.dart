...
//user name and profile function
  String? imageurl;
  String? username;

  void getuserdetails() async {
    var state = context.read<ProfileViewmodel>().state;
    if (state is ProfileLoadedState) {
      imageurl = state.profileModel.userDetails!.profilePhotoUrl;
      username = state.profileModel.userDetails!.name;
    }
  }
